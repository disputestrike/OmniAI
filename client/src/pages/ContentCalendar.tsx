    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Visual overview of all scheduled posts across platforms</p>
        </div>
          ...
          {calendarDays.map(({ date, isCurrentMonth }, idx) => {
            ...
            return (
              <div
                ...
                } ${isToday ? "bg-primary/5" : ""} ${isSelected ? "ring-2 ring-primary ring-inset" : ""} hover:bg-muted/30`}
              ...
              >
                ...
                <div className="space-y-0.5">
                  {posts.slice(0, view === "week" ? 10 : 3).map((post: any, i: number) => (
                    <div
                      key={i}
                      className={`text-[10px] px-1 py-0.5 rounded truncate border ${platformColors[post.platform] || "bg-muted text-muted-foreground"}`}
                  ...
                  {posts.length > (view === "week" ? 10 : 3) && (
                    <div className="text-[10px] text-muted-foreground text-center">+{posts.length - (view === "week" ? 10 : 3)} more</div>
                  )}
                </div>
              </div>
            );
