          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <FadeSection delay={300}>
              ...
              <button
                ...
                className="flex items-center gap-3 mx-auto px-6 py-3 bg-white border border-[#dadce0] rounded-xl shadow-sm hover:shadow-md hover:bg-gray-50 transition-all text-sm font-medium text-[#3c4043] mt-3"
              >
