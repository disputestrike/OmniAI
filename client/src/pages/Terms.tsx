    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1a1a1a]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="text-[#6b5e4f] leading-relaxed mb-10">
          Welcome to OmniAI. By accessing or using our platform, you agree to be bound by these Terms of Service ("Terms"). Please read them carefully. If you do not agree to these Terms, you may not use our service.
        </p>

        <Section title="1. Acceptance of Terms">
          <p>By creating an account or using OmniAI, you confirm that you are at least 16 years old, have the legal authority to enter into these Terms, and agree to comply with all applicable laws and regulations.</p>
        </Section>

        <Section title="2. Description of Service">
          <p>OmniAI provides an AI-powered marketing platform that enables users to create, manage, and publish marketing content across multiple platforms. Features include AI content generation, image and video creation, campaign management, competitor analysis, and multi-platform publishing.</p>
        ...
        <Section title="4. Acceptable Use">
          <p>You agree not to use OmniAI to:</p>
        ...
        <Section title="5. Content Ownership and License">
          <p><strong>Your Content:</strong> You retain ownership of all content you create, upload, or generate using OmniAI. By using our platform, you grant us a limited license to store, process, and display your content solely to provide the service.</p>
          ...
          <p><strong>Platform Content:</strong> Our platform, including its design, code, and proprietary AI models, is owned by OmniAI and protected by intellectual property laws.</p>
        </Section>

        <Section title="6. Third-Party Integrations">
          <p>OmniAI integrates with third-party platforms (Meta, Google, TikTok, etc.) and AI providers. Your use of these integrations is subject to the respective third-party terms of service. We are not responsible for the actions or policies of third-party platforms.</p>
          <p>When you connect advertising accounts, you authorize OmniAI to access and manage those accounts as specified during the authorization process.</p>
        </Section>
        ...
        <Section title="8. Disclaimer of Warranties">
          <p>OmniAI is provided "as is" and "as available" without warranties of any kind, express or implied. We do not warrant that the service will be uninterrupted, error-free, or that AI-generated content will meet your specific requirements or achieve particular marketing results.</p>
        </Section>

        <Section title="9. Limitation of Liability">
          <p>To the maximum extent permitted by law, OmniAI shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunities, arising from your use of the service.</p>
          <p>Our total liability for any claim shall not exceed the amount you paid us in the 12 months preceding the claim.</p>
        </Section>

        <Section title="10. Indemnification">
          <p>You agree to indemnify and hold harmless OmniAI, its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the service, violation of these Terms, or infringement of any third-party rights.</p>
        </Section>
